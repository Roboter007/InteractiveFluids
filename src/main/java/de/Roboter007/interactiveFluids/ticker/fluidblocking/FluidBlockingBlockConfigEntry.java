...
public class FluidBlockingBlockConfigEntry {
    ...
    static {
        CODEC = BuilderCodec.builder(FluidBlockingBlockConfigEntry.class, FluidBlockingBlockConfigEntry::new)
                ...
                .appendInherited(new KeyedCodec<>("KeepVanillaBehavior", Codec.BOOLEAN), (o, v) -> o.keepVanillaBehavior = v, (o) -> o.keepVanillaBehavior, (o, p) -> o.keepVanillaBehavior = p.keepVanillaBehavior).documentation("When BlocksFluid is false, the vanilla Hytale behavior will be used to check if it should block the fluid from flowing").add()
                .build();
